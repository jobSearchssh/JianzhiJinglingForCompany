...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if ([self.dataSource respondsToSelector:@selector(pickerView:titleForItem:)]) {
        ...
        if(self.selectedItem == indexPath.row){
            ...
            cell.imageView.image = [self compressImage:[self.dataSource pickerView:self imageForItem:indexPath.item]];
        }
...
{
    CGSize size = {imgSrc.size.width/2, imgSrc.size.width/2};
